 ...
 */
#define RD_NAS_88F68XX_GPP_OUT_ENA_LOW					\
	(~(BIT(1)  | BIT(4)  | BIT(6)  | BIT(7)  | BIT(8)  | BIT(9)  |	\
	   BIT(10) | BIT(11) | BIT(19) | BIT(22) | BIT(23) | BIT(25) |	\
	   BIT(26) | BIT(27) | BIT(29) | BIT(30) | BIT(31)))
#define RD_NAS_88F68XX_GPP_OUT_ENA_MID					\
	(~(BIT(0) | BIT(1) | BIT(2) | BIT(3) | BIT(4) | BIT(15) |	\
	   BIT(16) | BIT(17) | BIT(18)))

#define RD_NAS_88F68XX_GPP_OUT_VAL_LOW	0x0
#define RD_NAS_88F68XX_GPP_OUT_VAL_MID	0x0
#define RD_NAS_88F68XX_GPP_POL_LOW	0x0
#define RD_NAS_88F68XX_GPP_POL_MID	0x0

/* IO expander on Marvell RD_NAS board includes e.g. fan enabling */
...
int board_early_init_f(void)
{
	...
	writel(0x11203011, MVEBU_MPP_BASE + 0x0c);
	...
	/* Set GPP Out value */
	writel(RD_NAS_88F68XX_GPP_OUT_VAL_LOW, MVEBU_GPIO0_BASE + 0x00);
	writel(RD_NAS_88F68XX_GPP_OUT_VAL_MID, MVEBU_GPIO1_BASE + 0x00);

	/* Set GPP Polarity */
	writel(RD_NAS_88F68XX_GPP_POL_LOW, MVEBU_GPIO0_BASE + 0x0c);
	writel(RD_NAS_88F68XX_GPP_POL_MID, MVEBU_GPIO1_BASE + 0x0c);

	/* Set GPP Out Enable */
	writel(RD_NAS_88F68XX_GPP_OUT_ENA_LOW, MVEBU_GPIO0_BASE + 0x04);
	writel(RD_NAS_88F68XX_GPP_OUT_ENA_MID, MVEBU_GPIO1_BASE + 0x04);
